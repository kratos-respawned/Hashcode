...
function Register() {
  return (
    <>
      <div className="grid place-items-center   py-40 my-5 relative bg-cover font-poppins isolate  ">
        <Image fill alt="background" src={register} className=" object-cover  -z-10" />
